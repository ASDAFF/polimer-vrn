$(document).ready(function() {
    ...
    if(!$('.mp__products').length){
        ...
        if($('.ct__content .slider_product').length){
   ...
   */ 
    ...
    */
    ...
    $(document).on('click', '.popup .close', function(e){
        ...
        clicked.parents('.popup').velocity('fadeOut', 'fast')
    })
    ...
    $(document).on('change', '.pr_box .item .compare input', function(){
        ...
        if(elem.prop('checked')){
            parent.find('span').html('<a href="/compare/">Перейти к сравнению</a>');
        }else{
    ...
    $(document).on('change', '.bb_compare input', function(){
        ...
        if(elem.prop('checked')){
            parent.find('label').html('<a href="/compare/">Перейти к сравнению</a>');
        }else{
