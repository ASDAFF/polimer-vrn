...
<div class="or__content cl s3">
	...
	<div class="payment_types cl">
		...
		<a href="#" class="type t1">
			<?= str_replace(' ','<br>',$arPaySystem["PSA_NAME"]) ?>
			<input style="" type="radio" id="ID_PAY_SYSTEM_ID_<?= $arPaySystem["ID"] ?>" name="PAY_SYSTEM_ID" value="<?= $arPaySystem["ID"] ?>"<?if ($arPaySystem["CHECKED"]=="Y") echo " checked";?>>
		</a>
		<? endforeach; ?>
