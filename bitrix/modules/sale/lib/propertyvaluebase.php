...
abstract class PropertyValueBase extends Internals\CollectableEntity
{
	...
	public static function loadForOrder(OrderBase $order)
	{
		...
		{
			$relFilter[] = [
				'RELATION.ENTITY_TYPE' => 'P',
				'RELATION.ENTITY_ID' => $paySystemList
			];
		}
		...
		{
			$relFilter[] = [
				'RELATION.ENTITY_TYPE' => 'D',
				'RELATION.ENTITY_ID' => $deliveryList
			];
		}
	...
	{
		return [$order->getField('DELIVERY_ID')];
	}
