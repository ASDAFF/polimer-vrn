...
?><?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"COMPARE_PROPERTY_CODE" => array(
			...
			6 => "CML2_BASE_UNIT",
			7 => "FORUM_MESSAGE_CNT",
			8 => "OTAPLIVAEMOE_POMESHCHENIE_M_KUB",
			9 => "CML2_MANUFACTURER",
			10 => "CML2_TRAITS",
			11 => "CML2_TAXES",
			12 => "FORUM_TOPIC_ID",
			13 => "CML2_ATTRIBUTES",
			14 => "CML2_BAR_CODE",
			15 => "MAKS_GLUBINA_POGRUZHENIYA_M",
			16 => "RAZMER_PROFILYA_MM",
			17 => "NEOBKHODIMOST_OBSLUZHIVANIYA_ZIMOY",
			18 => "NAIMENOVANIE_SAYT02",
			19 => "UROVEN_SHUMA_DB",
			20 => "ALTERNATOR_",
			21 => "VOZMOZHNOE_PODKLYUCHENIE",
			22 => "GLUBINA_PROPILA_STAL_DREVESINA_MM",
			23 => "KOLEROVKA",
			24 => "VES_KG",
			25 => "TSVET",
			26 => "VNUTRENNIY_BAK",
			27 => "DIAPAZON_ZAKREPLYAEMYKH_SVERL_MM",
			28 => "NOMINALNYY_RASKHOD_M3_CHAS",
			29 => "VES_SNEGOVOGO_POKROVA_KG_KV_M",
			30 => "TOLSHCHINA_IZOLYATSII",
			31 => "RASKHOD_PRI_RABOTE_SHPATELEM_6KH6_MM_KG_KV_M",
			32 => "MAKS_RASKHOD_TOPLIVA_L_CHAS",
			33 => "DIAMETR_PODKL_KONTURA_OTOPLENIYA_DYUYM",
			34 => "EMKOST_SEKTSII_L",
			35 => "YEMKOST_AKKUMULYATORA_A_CH",
			36 => "ENERGIYA_UDARA_DZH",
			37 => "PROIZVODITEL",
			38 => "DIAMETR_USLOVNOGO_PROKHODA_MM",
			39 => "SVAROCHNYY_TOK_MIN_A",
			40 => "DIAMETR_DISKA_KRUGA_MM",
			41 => "TIP_PATRONA",
			42 => "TOLSHCHINA_SLOYA_MM",
			43 => "RAZMER_YACHEEK_FILTRA_MKM",
			44 => "GRUZOPODEMNOST_KG",
			45 => "PRIMENENIE",
			46 => "DIAPAZON_IZMERENIYA_DAVLENIYA_BAR",
			47 => "MAKSIMALNAYA_TEMPERATURA_S",
			48 => "MAKS_DIAM_SVERLENIYA_STAL_DREVESINA_BETON_MM",
			49 => "SHIRINA_MM",
			50 => "VID_IZDELIYA",
			51 => "MOROZOSTOYKOST",
			52 => "VREMYA_ZARYADKI_AKKUMULYATORA_CH",
			53 => "VYSOTA_MM",
			54 => "DIAPAZON_VKHODNOGO_NAPRYAZHENIYA_V",
			55 => "DIAMETR_PODKL_KONTURA_GORYACHEY_VODY_DYUYM",
			56 => "DIAMETR_VKHODNOGO_OTVERSTIYA_DYUYM",
			57 => "PROCHNOST_STSEPLENIYA",
			58 => "TEPLOSTOYKOST_S_NE_MENEE",
			59 => "TIP_POKRYTIYA_VERKH_NIZ",
			60 => "MAKS_KRUTYASHCHIY_MOMENT_N_M",
			61 => "VYSOTA_VSASYVANIYA_M",
			62 => "MEZHOSEVOE_RASSTOYANIE_MM",
			63 => "DIAMETR_PODKL_DYMOKHODA_MM",
			64 => "RABOCHEE_DAVLENIE_ATM",
			65 => "RAZMERY_SEKTSII_V_X_G_X_SH_MM",
			66 => "VNESHNIY_DIAMETR_V_MM_STALNYE_MEDNYE_TRUBY",
			67 => "MEZHPOVEROCHNYY_INTERVAL_LET",
			68 => "VREMYA_VYSYKHANIYA",
			69 => "SVAROCHNYY_TOK_MAX_A",
			70 => "TOLSHCHINA_PROFILYA_MM",
			71 => "TEMPERATURA_TEPLONOSITELYA_C",
			72 => "GARANTIYA_NA_VNUTRENNIY_BAK",
			73 => "ULTRAFIOLETOVAYA_ZASHCHITA",
			74 => "RASKHOD_NA_ODIN_SLOY",
			75 => "NAPRYAZHENIE_AKKUMULYATORA_V",
			76 => "RAZMERY_MM",
			77 => "TEMPERATURA_VOZGARANIYA_C",
			78 => "PROIZVODITELNOST_L_MIN",
			79 => "PRISOEDINENIE_DYUYM",
			80 => "DIAMETR_NASOSNOY_CHASTI_DYUYM",
			81 => "TIP_KAMERY_SGORANIYA",
			82 => "NAZNACHENIE",
			83 => "OBEM_MASLYANOGO_BAKA_L",
			84 => "TIP",
			85 => "POVERKHNOST",
			86 => "RASKHOD_TOPLIVA_G_KVTCH",
			87 => "KLASS_TOCHNOSTI",
			88 => "DEFORMATSIONNAYA_TEPLOSTOYKOST_C",
			89 => "CHASTOTA_UDAROV_UDAR_MIN",
			90 => "NAIMENOVANIE_SAYT01",
			91 => "TOLSHCHINA_STENKI_MM",
			92 => "UDERZHIVAEMYY_VES_KG_KV_M",
			93 => "TIP_AKKUMULYATORA",
			94 => "RASKHOD_MASLA_G_KVTCH",
			95 => "PODKLYUCHENIE_DYUYM",
			96 => "TEPLOOBMENNIK_",
			97 => "NOMINALNYY_TOK_A",
			98 => "MINIMALNYY_IZMERYAEMYY_RASKHOD_QMIN_M3_CH",
			99 => "ISPOLNENIE",
			100 => "GLUBINA_PROPILA_POD_UGLOM_90_45_MM",
			101 => "MOSHCHNOST_KVT",
			102 => "SVETOPRONITSAEMOST",
			103 => "CHASTOTA_KHODOV_KHOD_MIN",
			104 => "STEPEN_BLESKA",
			105 => "TEMPERATURA_PEREKACHIVAEMOY_ZHIDKOSTI_S",
			106 => "VREMYA_VYSYKHANIYA_CH",
			107 => "PROGRAMMIROVANIE",
			108 => "TIP_ROZZHIGA",
			109 => "MINIMALNYY_RADIUS_IZGIBA_DLYA_AROK_MM",
			110 => "SROK_EKSPLUATATSII_",
			111 => "TIP_POKRYTIYA",
			112 => "DYUYMY_STALNYE_MEDNYE_TRUBY",
			113 => "TSVET_1",
			114 => "GLUBINA_MM",
			115 => "GARANTIYA",
			116 => "NAIMENOVANIE_SAYT03",
			117 => "CHASTOTA_VRASHCHENIYA_OB_MIN",
			118 => "ZHIZNESPOSOBNOST_RASTVORA",
			119 => "VREMYA_UKLADKI_PLITKI_MIN",
			120 => "OBEM_DVIGATELYA_KUB_SM",
			121 => "MAKSIMALNYY_IZMERYAEMYY_RASKHOD_QMAKS_M3_CH",
			122 => "RASKHOD_PRI_10_MM_KG_KV_M",
			123 => "DIAMETR_LESKI_MM",
			124 => "MASSA_KG_KV_M_NE_MENEE",
			125 => "ENERGOPOTREBLENIE_NA_KV_M_VT_CH",
			126 => "NAPOR_M_VOD_ST_",
			127 => "UDELNYY_VES_KG_KV_M",
			128 => "RABOCHAYA_SREDA",
			129 => "REGULIROVKA_KRUTYASHCHEGO_MOMENTA",
			130 => "RABOCHEE_DAVLENIE",
			131 => "MOSHCHNOST_VT",
			132 => "NAPRYAZHENIE_SETI_V",
			133 => "TIP_POVERKHNOSTI",
			134 => "VREMYA_DO_PESHEGO_KHOZHDENIYA_CH",
			135 => "DIAMETR_PODKL_GAZOPROVODA_DYUYM",
			136 => "DIAMETR_MM",
			137 => "YEMKOST_TOPLIVNOGO_BAKA_L",
			138 => "REKOMENDUEMYY_DIAMETR_BURENIYA_MM",
			139 => "KARKAS",
			140 => "RASSTOYANIE_MEZHDU_RYEBRAMI_ZHYESTKOSTI_MM",
			141 => "TIP_KOTLA",
			142 => "DAVLENIE_BAR",
			143 => "MAKSIMALNOE_DAVLENIE_BAR",
			144 => "DIAMETR_TRUBY_DYUYM",
			145 => "DIAPAZON_IZMERENIYA_TEMPERATURY_S",
			146 => "DLINA_OBORUDOVANIYA_MM",
			147 => "USL_PROKHOD_V_MM_STALNYE_MEDNYE_TRUBY",
			148 => "VREMYA_KORREKTIROVKI_PLITKI_MIN",
			149 => "OBYEM_L",
			150 => "MAKS_DIAM_SVERLENIYA_BUROM_MM",
			151 => "RABOCHAYA_TEMPERATURA_C",
			152 => "DLINA_KABELYA_M",
			153 => "VREMYA_NAGREVA_NA_45_C_MIN",
			154 => "VODA",
			155 => "TIP_POLIROVKI",
			156 => "",
		),
